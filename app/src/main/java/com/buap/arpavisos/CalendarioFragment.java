...
public class CalendarioFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.tvEventDesc.setText(
                "Selecciona una fecha en el calendario para ver los eventos programados (ej. pulsa el 14 o 16 de Junio de 2026).");

        // Set date change listener on CalendarView to show system response/status
        ...
        binding.calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView view, int year, int month, int dayOfMonth) {
                ...
                String selectedDate = String.format(Locale.getDefault(), "%02d/%02d/%d", dayOfMonth, displayMonth,
                        year);
